...
// The calendar year + JS month index (0 = Jan) each MONTH_ORDER row
// actually falls in — July-Dec are the first calendar year of the
// school year, Jan-Jun are the next. Used to gray out a row once its
// whole month is behind today, even a month with nothing scheduled in
// it (like July once summer's over).
const SCHOOL_YEAR_START = 2026;
const MONTH_ORDER_INFO = [
  { year: SCHOOL_YEAR_START, monthIndex: 6 },      // July
  { year: SCHOOL_YEAR_START, monthIndex: 7 },      // August
  { year: SCHOOL_YEAR_START, monthIndex: 8 },      // September
  { year: SCHOOL_YEAR_START, monthIndex: 9 },      // October
  { year: SCHOOL_YEAR_START, monthIndex: 10 },     // November
  { year: SCHOOL_YEAR_START, monthIndex: 11 },     // December
  { year: SCHOOL_YEAR_START + 1, monthIndex: 0 },  // January
  { year: SCHOOL_YEAR_START + 1, monthIndex: 1 },  // February
  { year: SCHOOL_YEAR_START + 1, monthIndex: 2 },  // March
  { year: SCHOOL_YEAR_START + 1, monthIndex: 3 },  // April
  { year: SCHOOL_YEAR_START + 1, monthIndex: 4 },  // May
  { year: SCHOOL_YEAR_START + 1, monthIndex: 5 },  // June
];
